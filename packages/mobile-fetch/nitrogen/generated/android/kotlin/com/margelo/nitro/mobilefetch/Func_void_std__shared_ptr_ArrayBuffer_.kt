...
/**
 * Represents the JavaScript callback `(bytes: array-buffer) => void`.
...
fun interface Func_void_std__shared_ptr_ArrayBuffer_: (ArrayBuffer) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(bytes: ArrayBuffer): Unit
}
...
class Func_void_std__shared_ptr_ArrayBuffer__cxx: Func_void_std__shared_ptr_ArrayBuffer_ {
  ...
  private external fun invoke_cxx(bytes: ArrayBuffer): Unit
}
