...
namespace margelo::nitro::mobilefetch {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/mobilefetch/Func_void_std__string;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/mobilefetch/Func_void_std__string_cxx;";
