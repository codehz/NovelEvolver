...
namespace margelo::nitro::mobilefetch {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/mobilefetch/Func_void;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/mobilefetch/Func_void_cxx;";
