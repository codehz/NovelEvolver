...
/**
 * Wraps a Swift `(_ bytes: ArrayBuffer) -> Void` as a class.
...
public final class Func_void_std__shared_ptr_ArrayBuffer_ {
  ...
  private let closure: (_ bytes: ArrayBuffer) -> Void

  public init(_ closure: @escaping (_ bytes: ArrayBuffer) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(bytes: ArrayBuffer) -> Void {
    self.closure(bytes)
  }
