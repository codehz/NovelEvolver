...
export default function App() {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,#fff8ef_0%,#f5ead8_42%,#e8d8c0_100%)] px-6 py-10 text-stone-900">
      <section className="mx-auto flex min-h-[calc(100vh-5rem)] max-w-6xl flex-col justify-between rounded-4xl border border-black/8 bg-white/70 p-8 shadow-[0_30px_80px_rgba(88,61,37,0.14)] backdrop-blur md:p-12">
        ...
        <div className="grid gap-4 pt-10 text-sm text-stone-600 md:grid-cols-3">
          ...
          <article className="rounded-3xl border border-stone-200 bg-white/70 p-5">
            ...
            <p className="mt-2 leading-6">TailwindCSS v4 wired through the official Vite plugin.</p>
          </article>
          <article className="rounded-3xl border border-stone-200 bg-white/70 p-5">
