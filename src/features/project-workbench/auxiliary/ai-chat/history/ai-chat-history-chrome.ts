...
export const historyPopoverPanelClass = cn(
  "w-ai-chat-history-picker max-w-[min(22rem,calc(100vw-1rem))] origin-(--transform-origin) shadow-quick-pick outline-none",
...
export const historySearchInputClass = pickerSearchInputClass;
